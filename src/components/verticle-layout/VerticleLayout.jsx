...
class VerticleLayout extends Component {
    constructor(props) {
        super(props)
    ...
    processJson() {
        let a = [];
        const Json = this.props.data === undefined ? demoData : this.props.data;
        Json.map(data => {
            switch (data.type) {
                case "text":
                    a.push(<div>
                ...
                case "date":
                    a.push(
                        <MuiThemeProvider>
                            <div>
                                <DatePicker hintText="date picker" mode="landscape" onChange={this.handleDatePickerChange} />
                            </div>
                        </MuiThemeProvider>);
                    break;
                case "time":
